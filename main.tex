...
\begin{figure}[htp!]%
    \centering
    \subfloat[PC 1]{{\includegraphics[width=7cm]{figs/PCA_} }}%
    \qquad
    \subfloat[PC 2]{{\includegraphics[width=7cm]{figs/PCA_RED_True_cape-shear_magrot_725164_-4_nclust-11_prof-3452} }}%
    \qquad
    \subfloat[PC 3]{{\includegraphics[width=7cm]{figs/PCA_PROFILE_True_cape-shear_magrot_pi-2} }}%
    \qquad
    \subfloat[PC 4]{{\includegraphics[width=7cm]{figs/PCA_PROFILE_True_cape-shear_magrot_pi-3} }}%
